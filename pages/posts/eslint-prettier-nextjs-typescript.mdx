...
cover_image: https://images.pexels.com/photos/1687341/pexels-photo-1687341.jpeg
---
...
<p className="info">
  Eslint and Prettier are two separate tools, they can be run independently of each other, but we
  will leverage some very helpful ESlint plugins to combine them for maximum effect with minimal
  configuration.
</p>
