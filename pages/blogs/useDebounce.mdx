...
tags: debounce, react, hooks, javascript
cover_image: https://www.freecodecamp.org/news/content/images/size/w2000/2020/02/Ekran-Resmi-2019-11-18-18.08.13.png
---

_Debouncing is a performance optimization technique in JavaScript. It means to delay the execution of a function that you don’t want to run as often._

## Show me the code

If you would like to jump straight to the code, here you go -
Here's the interactive codesandbox demo for you to play around with yourself.

[![Edit useDebounce() React hook use with mouse position](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/usedebounce-react-hook-use-with-mouse-position-xhp6c?fontsize=14&hidenavigation=1&theme=dark)
